...
type ProductServiceClient interface {
	...
	GetProduct(ctx context.Context, in *ProductSKU, opts ...grpc.CallOption) (*Product, error)
	UpdateProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*Product, error)
	DeleteProduct(ctx context.Context, in *ProductSKU, opts ...grpc.CallOption) (*DeleteResponse, error)
	ListProducts(ctx context.Context, in *ProductListRequest, opts ...grpc.CallOption) (*ProductList, error)
}
...
func (c *productServiceClient) GetProduct(ctx context.Context, in *ProductSKU, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
...
func (c *productServiceClient) DeleteProduct(ctx context.Context, in *ProductSKU, opts ...grpc.CallOption) (*DeleteResponse, error) {
...
func (c *productServiceClient) ListProducts(ctx context.Context, in *ProductListRequest, opts ...grpc.CallOption) (*ProductList, error) {
	out := new(ProductList)
...
type ProductServiceServer interface {
	...
	GetProduct(context.Context, *ProductSKU) (*Product, error)
	UpdateProduct(context.Context, *Product) (*Product, error)
	DeleteProduct(context.Context, *ProductSKU) (*DeleteResponse, error)
...
func (UnimplementedProductServiceServer) GetProduct(context.Context, *ProductSKU) (*Product, error) {
...
func (UnimplementedProductServiceServer) DeleteProduct(context.Context, *ProductSKU) (*DeleteResponse, error) {
...
func _ProductService_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProduct(ctx, req.(*ProductSKU))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductService_DeleteProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).DeleteProduct(ctx, req.(*ProductSKU))
	}
	return interceptor(ctx, in, info, handler)
}
